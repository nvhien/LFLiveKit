...
NSString *const kGPUImageEarlyBirdFragmentShaderString = SHADER_STRING
                                                       (
...
@implementation GPUImageEarlyBirdFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageEarlyBirdFragmentShaderString])) {
        return nil;
    }
