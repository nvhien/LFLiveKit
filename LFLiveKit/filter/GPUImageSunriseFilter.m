...
NSString *const kLGPUImageSunriseFragmentShaderString = SHADER_STRING
                                                       (
...
@implementation GPUImageSunriseFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kLGPUImageSunriseFragmentShaderString])) {
        return nil;
    }
