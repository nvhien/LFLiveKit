...
NSString *const kGPUImageBrannanFragmentShaderString = SHADER_STRING
                                                       (
...
@implementation GPUImageBrannanFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageBrannanFragmentShaderString])) {
        return nil;
    }
