...
NSString *const kGPUImageFreudFragmentShaderString = SHADER_STRING
                                                       (
...
@implementation GPUImageFreudFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageFreudFragmentShaderString])) {
        return nil;
    }
...
- (void)setInputSize:(CGSize)newSize atIndex:(NSInteger)textureIndex {
    ...
    [self setFloat:newSize.height forUniformName:@"inputImageTextureHeight"];
    [self setFloat:newSize.width forUniformName:@"inputImageTextureWidth"];
}
